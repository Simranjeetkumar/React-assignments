...
export default function TableComp() {
  ...
  React.useEffect(()=>{
    ...
    get(`v1/admin/contents?page=1&limit=10&search=&status=&company=&format=`).then((res)=>{
      console.log('res',res.data.contentsData)
      // .title company_name
      setData(res.data.contentsData)
    })
  ...
  const visibleRows = React.useMemo(
    ...
    [order, data,orderBy, page, rowsPerPage],
  );
  ...
  return (
    <Box sx={{ width: '90%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        ...
        <TablePagination
        className='TableHead SelectLabel'
